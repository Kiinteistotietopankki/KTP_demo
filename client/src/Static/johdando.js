const JohdantoText = {
  Option1: `Tämä kuntoarvioraportti on laadittu Waativan toimesta kiinteistössä tehdyn tarkastuksen perusteella. Kuntoarvio on laadittu asuinkiinteistöjen kuntoarvion suoritusohjetta (RT 103003) soveltaen.
...
PTS-taulukoissa on esitetty kullekin tarkastuskohdenimikkeelle kuntoluokka. Tämä luokittelu on kuntoarvioijan arvio kohteen yleisestä kunnosta. Kuntoluokkien avulla voidaan eri rakennuksia ja rakennusosia verrata toisiinsa.

Käytetyt kuntoluokat ovat:
KL 5   Uusi, ei toimenpiteitä seuraavan 10 vuoden kuluessa
KL 4   Hyvä, kevyt huoltokorjaus 6-10 vuoden kuluessa
KL 3   Tyydyttävä, kevyt huoltokorjaus 1-5 vuoden kuluessa tai peruskorjaus 6-10 vuoden kuluessa
KL 2   Välttävä, peruskorjaus 1-5 vuoden kuluessa tai uusiminen 6-10 vuoden kuluessa
KL 1   Heikko, uusitaan 1-5 vuoden kuluessa
  `,
};

export default JohdantoText;
